    ...
    <div class="d-flex justify-content-between align-items-center mb-4 fade-in">
        <div>
            <h1 class="h3 mb-1 text-gray-800">
                <i class="bi bi-plus-circle me-2 text-primary"></i>Create New Subject
            </h1>
            <p class="text-muted small mb-0">Add a new subject to the curriculum</p>
        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="color" 
                                   ...
                                   value="{{ old('subject_color', '#667eea') }}"
