    ...
    <div class="d-flex justify-content-between align-items-center mb-4 fade-in">
        <div>
            <h1 class="h3 mb-1 text-gray-800">
                <i class="bi bi-plus-circle me-2 text-primary"></i>Create New Grade
            </h1>
            <p class="text-muted small mb-0">Add a new grade to the system</p>
        </div>
            ...
            <form action="{{ route('grades.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="grade_group" id="grade_group" class="form-select @error('grade_group') is-invalid @enderror">
                            ...
                            <option value="Primary" {{ old('grade_group') == 'Primary' ? 'selected' : '' }}>Primary</option>
                            <option value="Middle" {{ old('grade_group') == 'Middle' ? 'selected' : '' }}>Middle School</option>
                            <option value="High" {{ old('grade_group') == 'High' ? 'selected' : '' }}>High School</option>
                            <option value="Senior" {{ old('grade_group') == 'Senior' ? 'selected' : '' }}>Senior Secondary</option>
                        </select>
                        @error('grade_group')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary px-4">
                        <i class="bi bi-check-lg me-2"></i>Save Grade
                    </button>
