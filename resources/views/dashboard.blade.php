                                    ...
                                    <a href="{{ route('students.show', $student) }}" class="list-group-item list-group-item-action border-0 px-0">
                                        <div class="d-flex align-items-center">
                                            @if($student->file_path)
                                                <img src="/storage/{{ $student->file_path }}" alt="{{ $student->student_name }}" class="rounded-circle me-3 flex-shrink-0" width="40" height="40" style="width:40px;height:40px;object-fit:cover;">
                                            @else
                                                <div class="bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center me-3 flex-shrink-0 fw-bold" style="width:40px;height:40px;font-size:1rem;">
